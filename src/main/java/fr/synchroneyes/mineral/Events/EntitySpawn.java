...
public class EntitySpawn implements Listener {
    ...
    public void onEntitySpawn(EntitySpawnEvent e) throws Exception {
        ...
        if (mineralcontest.isAMineralContestWorld(worldEvent)) {
            ...
            if (e.getEntity() instanceof Monster || e.getEntity() instanceof Mob && !(e.getEntity() instanceof Chicken) && !(e.getEntity() instanceof Villager) && !(e.getEntity() instanceof Horse) && !(e.getEntity() instanceof ArmorStand)) {
